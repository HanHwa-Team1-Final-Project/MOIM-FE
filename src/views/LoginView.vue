        ...
        <v-card class="elevation-5 pt-5 rounded-card">
          ...
          <v-card-text>
            ...
            >
              ...
              >
                <div class="google-container">
                  <KakaoLogo class="google-logo" />
                  <span class="google-text">카카오 계정으로 계속하기</span>
                </div>
              </v-btn>
            </v-form>
          </v-card-text>
...
import KakaoLogo from "@/components/KakaoLogo.vue";

export default {
  components: { GoogleLogo, KakaoLogo },
  data() {
    return {
      form: false,
      email: "",
  ...
  methods: {
    ...
    googleLogin() {
      window.location.href = `${process.env.VUE_APP_API_BASE_URL}/oauth2/authorization/google?redirect_uri=https://www.jangeunji.shop/oauth2/redirect`;
    },
    kakaoLogin() {
      window.location.href = `${process.env.VUE_APP_API_BASE_URL}/oauth2/authorization/kakao?redirect_uri=https://www.jangeunji.shop/oauth2/redirect`;
    },
  },
};
</script>
